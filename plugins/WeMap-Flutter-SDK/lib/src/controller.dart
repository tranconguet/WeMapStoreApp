...
typedef void OnMapClickCallback(
    Point<double> point, LatLng coordinates, WeMapPlace place);
typedef void OnMapLongClickCallback(
    Point<double> point, LatLng coordinates, WeMapPlace place);
...
class WeMapController extends ChangeNotifier {
  ...
  Future<Fill> addFill(FillOptions options, [Map data]) async {
    ...
    final fill =
        await WeMapGlPlatform.getInstance(_id).addFill(effectiveOptions);
    _fills[fill.id] = fill;
    notifyListeners();
    return fill;
  }
